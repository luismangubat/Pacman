...
//                if (barrier.getSystemCoordX() < pac.getX()) {
            ...
            if (pac.getHitBox().intersects(orangeFreddy.getHitBox())) {
                pac = new Pacman(50, 335, Color.yellow, 20, 20);
        ...
        orbs.add(new Orb(177, 114, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(177, 135, orbDiameter, Color.ORANGE));
        
        orbs.add(new Orb(198, 135, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(219, 135, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(240, 135, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(261, 135, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(282, 135, orbDiameter, Color.ORANGE));
        
        orbs.add(new Orb(330, 135, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(351, 135, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(372, 135, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(393, 135, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(414, 135, orbDiameter, Color.ORANGE));
        orbs.add(new Orb(433, 135, orbDiameter, Color.ORANGE));
        
        orbs.add(new Orb(433, 114, orbDiameter, Color.ORANGE));
...
//            graphics.setFont();
            ...
            graphics.drawString("" + score, 765, 70);
            graphics.draw3DRect(650, 10, 225, 100, true);
